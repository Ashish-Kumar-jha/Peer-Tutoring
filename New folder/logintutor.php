            ...
            <div class="container">
              <div class="row align-items-center">
                <div class="col-12">
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <h1  data-aos="fade-up" data-aos-delay="100">Welcome Back Tutor <span class="pl-3"></h1>
                      
                        <p class="mb-4">Peer tutoring is children helping other children to learn. Sometimes older children help younger children, while other times more able children can help less able children of the same age.</p>

                    <!--  <p class=" p-t-15 mb-4"  data-aos="fade-up" data-aos-delay="200"><span class="badge badge-danger">Important</span> -  Online Mode Available</p>
                     <p class="mb-4"  data-aos="fade-up" data-aos-delay="200"><span class="badge badge-danger">Important</span> -  Telephonic Mode Available</p>
                     <p class="mb-4"  data-aos="fade-up" data-aos-delay="200"><span class="badge badge-danger">Important</span> -  Offline Mode Available</p>     -->                
                      
                    </div>

                    <div class="col-lg-5 ml-auto " data-aos="fade-up" data-aos-delay="500">
                    <form action="Tlogin.php" method="post" class="form-box">
                      <h3 class="h4 text-black mb-4">Login Tutor</h3>
                      ...
                      <div class="form-group">
                        <input type="submit" name="submit" class="btn btn-primary btn-pill" value="Login Tutor">
                      </div>
					  <div class="form-group">

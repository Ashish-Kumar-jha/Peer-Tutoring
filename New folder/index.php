            ...
            <div class="ml-auto w-25">
              <nav class="site-navigation position-relative text-right" role="navigation">
                <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                  <li class="cta"><a href="signup.php" class="nav-link"><span>Signup</span></a></li>
                </ul>
              </nav>
        ...
        <div class="slide-1" style="background-image: url('images/hero_1.jpg');" data-stellar-background-ratio="0.5">
          <div class="container">
            <div class="row  align-items-center">
              <div class="col-12">
                <div class="row ">
                <div class="col-lg-6 mb-4 py-1">
                    <h1  data-aos="fade-up" data-aos-delay="100" style="font-weight: 10px" class="ml-5">Peer Tutoring</h1>
                    <p class="mb-4 ml-5"  data-aos="fade-up" data-aos-delay="200">Make Learning More Comfortable</p>
                     <span> <div class="container">
                    <p data-aos="fade-up" data-aos-delay="300"><a href="signuptutor.php" class=" btn btn-primary py-3 px-5 ml-5 btn-pill mb-2">Signup As Tutor</a></p>
                    
                   <p data-aos="fade-up" data-aos-delay="300"><a href="logintutor.php" class=" btn btn-primary py-3 px-5 ml-5 btn-pill  mb-2">Login As Tutor</a></p></span>
				            <!-- </div> -->
                    <!-- <div class="container">   -->
                  <p data-aos="fade-up" data-aos-delay="300"><a href="loginadmin.php" class=" btn btn-primary py-3 px-5 ml-5 btn-pill  mb-2">Login As Admin</a></p>
                  </div>
                  </div>

                  <div class="col-lg-5 ml-auto " data-aos="fade-up" data-aos-delay="500">
                    <form action="Slogin.php" method="post" class="form-box">
                      <h3 class="h4 text-black mb-2">Login</h3>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="owl-carousel col-12 nonloop-block-14">
              ...
              <div class="course bg-white h-100 align-self-stretch">
                <figure class="m-0">
                  <a href="course-single.html"><img src="images/plsql.png" alt="Image"  height="250px" width="40px" class="p-5"></a>
                </figure>
                <div class="course-inner-text py-4 px-4">
                  <span class="course-price">₹20</span>
